  ...
  return (
    <div className="app-bg">
      <div className="max-w-6xl mx-auto py-8">
        {view === "landing" && <Landing onStart={() => setView("start")} onResults={() => setView("results")} onSettings={() => setView("settings")} onFixtures={() => setView("fixtures")} imgStart={imgStart} imgScore={imgScore} imgSettings={imgSettings} />}
